...
$(document).ready(function() {
     ...
     */
    $('#example2 tbody td:first-child i').live('click', function () {
...
function fnFormatDetails ( oTable, nTr )
{
    ...
    var data = $('#tr-user-' + nTr['_DT_RowIndex']).data('user'); 
    var sOut = '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;" class="inner-table">';
    sOut += '<tr><td>Gender:</td><td>' + toTitleCase(data['gender']) + '</td></tr>';
    sOut += '<tr><td>Birth Date:</td><td>' + moment(data['birth_date']).format('MMMM Do YYYY'); + '</td></tr>';
    sOut += '<tr><td>Address:</td><td>' + data['address'] + ', ' + data['country'] + ', ' + data['postal_code'] + '</td></tr>';
    sOut += '<tr><td>Address:</td><td>' + data['phone_number'] + '</td></tr>';
    sOut += '</table>';
